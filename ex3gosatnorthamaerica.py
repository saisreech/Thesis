...
#Can be used for multiple number of variables for GOSAT and places over the world by changing latitude and longitude values. The below is for  north america satellite data 
...
def transferData(fileName):
		...
		df = df[(df.latitude >= 30) & (df.longitude >= -120)]
		df = df[(df.latitude <= 50) & (df.longitude <= -70)]
...
#python ex3gosatnorthamaerica.py -i "/home/saisree1/GOSATnew/" --ofolder "/home/saisree1/GOSATnew/gosatnorthamerica/"
